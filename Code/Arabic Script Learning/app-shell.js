(function registerShell() {
  ...
  runtime.elements = {
    ...
    choiceTypeNames: document.getElementById("choice-type-names"),
    choiceTypeWords: document.getElementById("choice-type-words"),
    choicePromptLabel: document.getElementById("choice-prompt-label"),
    choiceSymbolPair: document.getElementById("choice-symbol-pair"),
    choiceSymbol: document.getElementById("choice-symbol"),
    choiceContextSample: document.getElementById("choice-context-sample"),
    choiceContextSymbol: document.getElementById("choice-context-symbol"),
